export const londonProperties = [
  ...
  },
  {
    id: "4",
    image:
      "https://images.unsplash.com/photo-1484154218962-a197022b5858?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2274&q=80",
    title: "Room in Wandsworth",
    price: "$114 for 2 nights · 4.78",
    rating: 4.78,
    isGuestFavorite: true,
  },
  {
    ...
    title: "Apartment in Camden",
    price: "$253 for 2 nights · 4.88",
    rating: 4.88,
    isGuestFavorite: true,
  },
  {
...
export const capeTownProperties = [
  ...
  },
  {
    id: "14",
    image:
      "https://images.unsplash.com/photo-1600566753151-384129cf4e3e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
